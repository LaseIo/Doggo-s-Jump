...
def menu():
    ...
    image_icone = PhotoImage(file="doggo_sprite.png")
    root.iconphoto(False, image_icone)

    fond_ecran = PhotoImage(file="interface_background.png")
    ...
    bouton_jouer = PhotoImage(file="button_doggos_jump_cool.png")
    ...
    bouton_quitter = PhotoImage(file="bouton_quit_final.png")
...
def game():
    ...
    ecran = PhotoImage(file="interface_background.png")
